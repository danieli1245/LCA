...
public class LCATest {
    ...
    public void EmptyRoot() {
        ...
        assertEquals("LCA of 8 and 4 is ",-1, tree.findLCA(tree.root,8,4)); //testing empty tree
    ...
    public void LCATest() {
        ...
        assertEquals("LCA of 8 and 4 is ",2, tree.findLCA(tree.root,8,4));
        assertEquals("LCA of -8 and -4 is ", -1, tree.findLCA(tree.root,-8, -4));
